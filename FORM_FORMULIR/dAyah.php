    ...
    <div class="container-fluid p-5">
        ...
        <form method="post">
            <nav class="nav bg-dark mb-3">
                <a class="nav-link text-white" href="#">DATA AYAH KANDUNG</a>
            </nav>
            <div class="form-group">
                <label for="">34. Nama Ayah Kandung : </label>
                <input type="text" name="nama_ayah" id="" class="w-50">
            </div>
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="w-25" name="ayah_abk">
                </div>

                <button type="submit" class="btn btn-primary" value="simpan" name="prosesTambah">Simpan Data</button>
                <button type="submit" class="btn btn-success next"><a href=dIbu.php
...
if (isset($_POST['prosesTambah'])) {
    mysqli_query($koneksi, "insert into d_ayah set 
    nama_ayah = '$_POST[nama_ayah]',    
    tahun_lahir = '$_POST[tahun_lahir]',    
    pendidikan = '$_POST[pendidikan]',
    pekerjaan = '$_POST[pekerjaan]',    
    penghasilan = '$_POST[penghasilan]',
    ayah_abk = '$_POST[ayah_abk]'");
